    ...
    return (
        <div style={{display:'flex' , flexDirection:'column' }}>
			{playersInfo.map((player) => {
                ...
                textcolorlist = <a style={{ fontSize:26 }}> {player.name} {player.user_name === minister ? "M" : ""} {player.user_name === director ? "D": ""} {player.user_name ===  candidateMinister ? "Next M" : ""} {player.user_name ===  candidateDirector ? "Next D" : ""}</a>
